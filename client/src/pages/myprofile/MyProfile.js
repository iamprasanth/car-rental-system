                ...
                <div className="post">
                    <Tabs defaultActiveKey="posts" id="uncontrolled-tab-example">
                        ...
                        <Tab eventKey="followers" title="Followers">
                            <UserList users={user ? user.followers : {}} emptyMessage="No followers now" showFilter={true} />
                        </Tab>
                        <Tab eventKey="followings" title="Followings">
                            <UserList users={user ? user.followings : {}} emptyMessage="Following no one" showFilter={true} />
                        </Tab>
                        <Tab eventKey="profile" title="Profile">
                            <EditProfile user={user} loadUserPosts={loadUserPosts} />
                        </Tab>
                    </Tabs>
                </div>
            </div>
